...
# B says "We are of different kinds." one is knight, the other a  knave
knowledge2 = And(
    KnowledgeBase,
...
S1 = Or(AKnight,AKnave)
A_said = AKnave

knowledge3 = And(
    KnowledgeBase,
    Implication(BKnight, And(Implication(AKnight, AKnave),
                             Implication(AKnave, Not(AKnave)))),#if b knight then if a knight, a knave, if a knave then not a knave
